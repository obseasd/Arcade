                ...
                <div className="flex items-start gap-3 border-t border-arc-border/40 bg-arc-warn/5 p-4 text-xs text-arc-text-muted">
                    ...
                    <div className="space-y-2">
                        <div>
                            ...
                            contract, gated by a per-wallet entitlement (KYC).
                            Once a wallet is whitelisted, the in-app deposit /
                            redeem flow becomes available (wiring in progress).
                            Your USYC balance already reads here.
                        </div>
